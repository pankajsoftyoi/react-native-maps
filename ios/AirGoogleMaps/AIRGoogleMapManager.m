...
RCT_EXPORT_VIEW_PROPERTY(boundaryPlaceId, NSString)
RCT_EXPORT_VIEW_PROPERTY(boundaryStrokeColor, UIColor)
RCT_EXPORT_VIEW_PROPERTY(boundaryStrokeWidth, double)
RCT_EXPORT_VIEW_PROPERTY(boundaryFillColor, UIColor)
